...
var destinationUrl = document.getElementById('url');  //decide where the file is uploading to
...
(function(){
    ...
    function uploadNext() {
        if (list.length) {
            ...
            if (nextFile.size >= 104857600) { // 100MB
                result.innerHTML += '<div class="f">*uploadscript.js*Too big file (max filesize exceeded)</div>';
